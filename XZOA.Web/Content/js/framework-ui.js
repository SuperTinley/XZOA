...
$.currentWindow = function () {
    var iframeId = top.$(".XZOA_iframe:visible").attr("id");
...
$.fn.formSerialize = function (formdate) {
    ...
    var postdata = {};
    element.find('input,file,select,textarea').each(function (r) {
        var $this = $(this);
        var id = $this.attr('id');
        ...
        switch (type) {
            ...
            case "radio":
                ...
                break;
            //case "file":
            //    var files = $('input[name="' + id + '"]').prop('files');
            //    if (files.length > 0) {
...
$.fn.authorizeButton = function () {
    var moduleId = top.$(".XZOA_iframe:visible").attr("id").substr(6);
